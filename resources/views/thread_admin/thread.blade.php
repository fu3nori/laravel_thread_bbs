...
@endif
    ...
    <br>スレッド配下のレスを個別削除する場合は個別レス削除ボタンをクリックしてレス一覧を表示して下さい。</b></p>
    @foreach($threads as $thread)
        ...
        {{Form::open(['url' => '/thread_admin/threadres'.'/'.$thread['id']])}}
        {{Form::submit('個別レス削除', ['class'=>'btn btn-primary btn-block'])}}
        {{Form::close()}}
        @endif
