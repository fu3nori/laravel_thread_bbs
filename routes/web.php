...
Route::get('/thread/view/{id}/{bbs_responses_id}','ThreadController@view');
// スレ単独から投稿
...
Route::group(['middleware' => 'admin'], function() {
    ...
    Route::post('/thread_admin/threadres/{id}' , 'ThreadAdminController@threadres');
    Route::get('/thread_admin/threadres/{id}' , 'ThreadAdminController@threadres');
    Route::post('/thread_admin/deleteres/' , 'ThreadAdminController@deleteres');
});
